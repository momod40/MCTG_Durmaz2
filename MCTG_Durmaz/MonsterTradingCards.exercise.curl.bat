...
echo should fail:
curl -X POST http://localhost:10001/sessions --header "Content-Type: application/json" --header "Authorization: Bearer admin-mtcgToken" -d "{\"Username\":\"kienboec\", \"Password\":\"different\"}"
echo.
echo.
...
REM --------------------------------------------------
echo 22) unique feature
curl -X GET http://localhost:10001/weeklygift --header "Authorization: Bearer kienboec-mtcgToken"
echo end...
